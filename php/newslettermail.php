...
if($emailnewsletter!=''){
    ...
    if (getenv('HTTP_CLIENT_IP'))
       ...
       $ipaddress = getenv('HTTP_FORWARDED');
        ...
        $ipaddress = 'UNKNOWN';  
$subject = "Subscribe To Newsletter: " . $emailnewsletter . "  ON ".date("Y-m-d");
...
align=center colspan=2>FBSPL SUBSCRIBE TO NEWSLETTER</td></tr>
<tr> <td style='border:1px solid #e8e8e8;padding:10px;color:#444;background:#f9f9f9'width=150>
<strong>Email</strong></td><td style='border:1px solid #e8e8e8;padding:10px 5px'width=444>". $emailnewsletter ."</td></tr>
...
try {
    ...
    $mail->addCC($emailnewsletter,'Reply');            
    //Content
    $mail->isHTML(true);                     
