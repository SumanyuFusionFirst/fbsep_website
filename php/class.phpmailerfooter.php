...
class PHPMailer {
  ...
  */
   ...
   * @var string
   */
  public $Sendmailfooter          = '/usr/sbin/sendmailfooter';
 ...
 /**
   ...
   * @var string
   */
  public $DKIM_selector   = 'phpmailerfooter';
  ...
  public function IsSendmail() {
    if (!stristr(ini_get('sendmailfooter_path'), 'sendmailfooter')) {
      $this->Sendmail = '/var/qmail/bin/sendmailfooter';
    }
    $this->Mailer = 'sendmailfooter';
  }
  ...
  public function IsQmail() {
    if (stristr(ini_get('sendmailfooter_path'), 'qmail')) {
      $this->Sendmail = '/var/qmail/bin/sendmailfooter';
    }
    $this->Mailer = 'sendmailfooter';
  }
 ...
 */
  ...
  protected function SendmailSend($header, $body) {
    if ($this->Sender != '') {
      $sendmailfooter = sprintf("%s -oi -f %s -t", escapeshellcmd($this->Sendmailfooter), escapeshellarg($this->Sender));
    } else {
      $sendmailfooter = sprintf("%s -oi -t", escapeshellcmd($this->Sendmailfooter));
    }
    if ($this->SingleTo === true) {
      foreach ($this->SingleToArray as $key => $val) {
        if(!@$mail = popen($sendmailfooter, 'w')) {
          throw new phpmailerException($this->Lang('execute') . $this->Sendmailfooter, self::STOP_CRITICAL);
        }
        fputs($mail, "To: " . $val . "\n");
        fputs($mail, $header);
        fputs($mail, $body);
