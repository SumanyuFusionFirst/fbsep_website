        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <div class="form-group col">
                    <!-- <a href="<?=$baseurl2?>/book-free-consultation-call"
                    ...
                    <a href="<?=$baseurl2?>/contact-fbspl" class="btn btn-modern btn-primary btn-outline-light btn-arrow-effect-1 btn-rounded text-3 mt-2">Let's
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
               ...
               <span class="text-color-light text-5 font-weight-normal m-2 mt-2" style="vertical-align:middle">or</span> -->
                    <a href="<?=$baseurl2?>/contact-fbspl" class="btn btn-modern btn-primary btn-outline-light btn-arrow-effect-1 btn-rounded text-1">Let's
                        Talk<i class="fas fa-arrow-right ms-2"></i></a>
                </div>
            </div>
        </div>
                        ...
                        <ul class="list list-icons list-icons-lg">
                            <li class="d-flex px-0 mb-1">
                              ...
                              c106.2,0,192.6,86.4,192.6,192.7C398.1,224,391.4,230.7,383.1,230.7L383.1,230.7z">
                                ...
                                <a href="tel:+44-788-331-8386" class="text-color-light text-2-4 ms-2">+44-788-331-8386</a>
                            </li>
                            <li class="d-flex text-color-light px-0 mb-1">
                                <div class="animated-icon animated fadeIn svg-fill-color-light me-2">
                                    <!--?xml version="1.0" encoding="utf-8"?-->
                    ...
                    <div class="col-lg-4 custom-sm-margin-top mt-4">
                        ...
                        <ul class="list list-icons list-icons-sm">
                            <li>
                                ...
                                <a href="<?=$baseurl2?>/faqs" class="link-hover-style-1 ms-1 text-color-light">FAQs</a>
                            </li>
                            <li>
                                <i class="fas fa-angle-right text-color-default"></i>
                                <a href="<?=$baseurl2?>/blog" class="link-hover-style-1 ms-1 text-color-light">Blog</a>
                            </li>
                            <li>
                                <i class="fas fa-angle-right text-color-default"></i>
                                <a href="<?=$baseurl2?>/submit-guest-post" class="link-hover-style-1 ms-1 text-color-light">Become a
                                    Guest Writer</a>
                            </li>

                            <li>
                                <i class="fas fa-angle-right text-color-default"></i>
                                <a href="https://www2023.fusionfirst.com/img/Corporate-Social-Responsibility-Policy.pdf" target="_blank" class="link-hover-style-1 ms-1 text-color-light">CSR Event</a>
                            </li>

                            <li>
                                <i class="fas fa-angle-right text-color-default"></i>
                                <a href="<?=$baseurl2?>/sitemap" class="link-hover-style-1 ms-1 text-color-light">Sitemap</a>
                            </li>
                            <!-- <li>
                     <i class="fas fa-angle-right text-color-default"></i>
                    ...
                    <div class="col-lg-4 custom-sm-margin-top mt-4">
                     ...
                     <a href="demo-business-consulting-3-contact.html"
                        class="link-hover-style-1 ms-1 text-color-light">Services</a>
                            ...
                            <li>
                                <i class="fas fa-angle-right text-color-default"></i>
                                <a href="<?=$baseurl2?>/book-free-consultation-call" class="link-hover-style-1 ms-1 text-color-light">Free Consultation</a>
                            </li>
                            <li>
                                <i class="fas fa-angle-right text-color-default"></i>
                                <a href="mailto:escalation@fusionfirst.com" class="link-hover-style-1 ms-1 text-color-light">Escalation Resolutions</a>
                            </li>
                            <li>
                                <i class="fas fa-angle-right text-color-default"></i>
                                <a href="<?=$baseurl2?>/client-testimonial-reviews" class="link-hover-style-1 ms-1 text-color-light">Testimonials</a>
                            </li>
                            <li>
                                <i class="fas fa-angle-right text-color-default"></i>
                                <a href="<?=$baseurl2?>/privacy-policy" class="link-hover-style-1 ms-1 text-color-light">Privacy
                                    Policy</a>
                            </li>
                            <li>
                                <i class="fas fa-angle-right text-color-default"></i>
                                <a href="<?=$baseurl2?>/security-measures-at-fbspl" class="link-hover-style-1 ms-1 text-color-light">Security Measures</a>
                            </li>
                            <li>
                                <i class="fas fa-angle-right text-color-default"></i>
                                <a href="<?=$baseurl2?>/gdpr" class="link-hover-style-1 ms-1 text-color-light">GDPR</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col my-1 mb-2">
                            <div class="custom-input-box">
                                ...
                                <input class="form-control" minlength="5" type="text" data-msg-email="" name="source" id="sourcefooter" placeholder="Where did you find us*" style="height: 34px;" required />
                    ...
                    <div class="row">
                        <div class="form-group col my-1">
                            <div class="custom-input-box">
                                ...
                                <textarea style="min-height: 60px  !important;" minlength="6" maxlength="5000" type="text" data-msg-email="" rows="2" class="form-control" name="message" placeholder="Message*" id="subfooter" required></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-9 text-center">
                <p class="text-light mt-3">This website uses cookies to ensure you get the best experience on our website. <a href="<?=$baseurl2?>/privacy-policy">More info</a></p>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center pb-4">
                <p>© 2024 All Rights Reserved - Fusion Business Solutions (P) Limited</p>
            </div>
        </div>
    </div>
</footer>
...
<a href='https://ebusinesspages.com/Fusion-E-Solutions-LLC_ejkja.co'><img border='0' src='https://ebusinesspages.com/i/lbs.png' aria-label='Business management in Briarcliff Manor' style="display:none"></a>
<a class="scroll-to-top visible whatsappIcon" href="https://wa.link/pb0xuv" aria-label="Whatsapp" target="_blank" style="bottom: 30%;opacity: 1;border-radius: 10% !important; background: #25D366 !important;color: #fff !important;padding-bottom: 40px;"><i class="fa-brands fa-whatsapp" style="font-weight:500"></i></a>
<script defer src="<?= $baseurl2 ?>/js/footeremail.js?d=<?= date("Y-m-d-H-i-s", time()) ?>"></script>
<!-- Vendor -->
...
<script defer src="<?= $baseurl2 ?>/js/views/view.contact.js"></script>
<!-- Theme Custom -->
<script defer src="<?= $baseurl2 ?>/js/custom.js"></script>
...
<script type="text/javascript" id="hs-script-loader" async defer src="//js.hs-scripts.com/23620181.js"></script>
...
<script
    ...
    document.addEventListener("DOMContentLoaded", function() {
        var paragraphs = document.querySelectorAll('.motion_para_blog3');
        var currentIndex = 0;
 
        function typeEffect(element, speed) {
            var text = element.innerHTML;
            element.innerHTML = '';
            var firstLetterDisplayed = false; // Flag to track if first letter is displayed
 
            var i = 0;
            var timer = setInterval(function() {
                if (!firstLetterDisplayed) {
                    // Display the first letter immediately
                    element.innerHTML += text.charAt(i);
                    i++;
                    firstLetterDisplayed = true;
                } else if (i < text.length) {
                    // Display rest of the text one character at a time
                    element.innerHTML += text.charAt(i);
                    i++;
                } else {
                    clearInterval(timer);
                    ...
                    setTimeout(function() {
                        typeEffect(paragraphs[currentIndex], speed);
                    }, 1000);
                }
            }, speed);
        }
        typeEffect(paragraphs[currentIndex], 200);
    });
</script>
<script>
     $('.single-item').slick({
...
<script defer type="application/ld+json">
    {
        ...
        "@type": "Organization",
        "name": "Fusion Business Solution Private Limited",
        "url": "https://fusionfirst.com/",
        "logo": "https://www2023.fusionfirst.com/img/FBSPL/header/fbspllogo.svg",
        "description": "Fusion Business Solutions Private Limited (FBSPL) is an ITES and BPM company founded in 2006. We provide business process management and IT service delivery solutions to businesses worldwide.Aptly named, Fusion brings together different cultures, ideas, technology, innovation, and ethnicities to impact how businesses operate. Keeping U first is its mantra, and it is equally applied to FBSPL's team members, partners, clients, and service providers.",
        "address": {
            "@type": "PostalAddress",
            "streetAddress": "F-37, IT Park",
            "addressLocality": "MIA Extension",
        ...
        "contactPoint": {
            "@type": "ContactPoint",
            "contactType": "contact",
            "telephone": "977-227-9996",
            "email": "info@fusionfirst.com"
        },
        "areaServed": [{
            "@type": "Country",
            "name": ["United States", "United Kingdom", "Canada"]
        }],
        "sameAs": ["https://www.facebook.com/FBSPLTeam",
