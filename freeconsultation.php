<section class="section section-with-shape-divider position-relative bg-light py-2 border-0 m-0">
    <div class="col-lg-7 text-center text-lg-center py-5 py-lg-0 align-self-center px-2" style="margin:auto">
        ...
        <div class="card border-0 bg-color-light">
            <div class="card px-lg-4 py-4 box-shadow-6 border-radius-2">
                ...
                <h2 class="text-color-primary font-weight-bold text-6 ls-0 pb-2 mb-1">Inquire now</h2>
                <p>Write to us, we'll respond promptly!</p>

                <form class="contact-form form-style-3" id="BodyEmail1" method="POST" novalidate="novalidate">
                    ...
                    <div class="row row-gutter-sm">
                        <div class="form-group col-lg-6 p-0 px-3 m-0 my-2">
                            <input type="text" value="" data-msg-required="Please enter your name." maxlength="100"
                                class="form-control" name="name" id="name1" required="" placeholder="Your Name">
                        </div>
                        <div class="form-group col-lg-6 p-0 px-3 m-0 my-2">
                            <input type="text" value="" data-msg-required="Please enter your phone number."
                                class="form-control" name="phone" id="phone1" required="" placeholder="Phone Number"
                    ...
                    <div class="row row-gutter-sm">
                        <div class="form-group col-lg-6 p-0 px-3 m-0 my-2">
                            <input type="email" value="" data-msg-required="Please enter your email address."
                                ...
                                class="form-control" name="email" id="email1" required="" placeholder="Your Email">
                        </div>
                        <div class="form-group col-lg-6 p-0 px-3 m-0 my-2">
                            <input type="text" value="" data-msg-required="Please enter the Company Name."
                                maxlength="100" class="form-control" name="Company" id="CompanyName" required=""
                    ...
                    <div class="row row-gutter-sm">
                        ...
                        <div class="form-group col-md-6 p-0 px-3 m-0 my-2">
                            <div class="dropdown" data-control="checkbox-dropdown">
                                <label class="dropdown-label text-3"
                                    style="padding: 16px;background-color: #F4F4F4;border: none;height:47px;">Please
                                    Select Services</label>

                                <div class="dropdown-list" style="z-index: 1;" id="checkBox">

                                    <label class="dropdown-option">
                                        <input type="checkbox" value="Recruitment Services" name="dropdown-group">
                                        Recruitment Services
                                    </label>

                                    <label class="dropdown-option">
                                        <input type="checkbox" value="Insurance Services" name="dropdown-group">
                                        Insurance Services
                                    </label>

                                    <label class="dropdown-option">
                                        <input type="checkbox" value="Accounting&amp;Bookkeeping Service"
                                            name="dropdown-group">
                                        Accounting&amp;Bookkeeping Service
                                    </label>

                                    <label class="dropdown-option">
                                        <input type="checkbox" value="Data Annotation Services" name="dropdown-group">
                                        Data Annotation Services
                                    </label>

                                    <label class="dropdown-option">
                                        <input type="checkbox" value="Health Care Services" name="dropdown-group">
                                        Health Care Services
                                    </label>

                                    <label class="dropdown-option">
                                        <input type="checkbox" value="Customer Support Services" name="dropdown-group">
                  ...
                  Interest
                                    ...
                                    <label class="dropdown-option">
                                        <input type="checkbox" value=" Other Services" name="dropdown-group">
                                        Other Services
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="form-group col-lg-6 p-0 px-3 m-0 my-2">
                            <input type="text" value="" maxlength="100" class="form-control"
                                name="Where did you find us?" id="source" placeholder="Where did you find us?">
                        </div>
                    </div>
                    <div class="row row-gutter-sm p-0 px-3 m-0 my-2">
                        ...
                        <div class="form-group col-lg-4 p-0 px-3 m-0 my-2">
                            ...
                            <input type="date" value="" data-msg-required="Please enter Date."
                                data-msg-email="Please enter date" maxlength="100" class="form-control" name="date"
                                id="date" required="" placeholder="dd-mm-yyyy" min="2023-02-28">
                        </div>

                        <div class="form-group col-lg-4 p-0 px-3 m-0 my-2">
                            <label>Time</label>
                            <input type="time" value="" data-msg-required="Please enter time" class="form-control"
                                id="time" required="">
                        </div>
                        <!-- <div class="form-group col-lg-4 p-0 px-3 m-0 my-2">
                            <label>Time</label>
                        ...
                        <div class="form-group col-lg-4 p-0 px-3 m-0 my-2">
                            <div class="custom-input-box">
                                ...
                                <input class="form-control" list="productName" autocomplete="off" type="text"
                                    name="source" id="timezone" placeholder="Select Timezone" required="">
                                <datalist id="productName">
                                    ...
                                    <option selected="" value="GMT+0530 (India Standard Time)">GMT+0530 (India Standard
                                        Time)</option>
                                </datalist>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col p-0 px-3 m-0 my-2">
                            <textarea maxlength="5000" data-msg-required="Please enter your message." rows="2"
                                class="form-control" name="message" id="note1" required=""
                                placeholder="Please specify what would you like to discuss?"></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col mb-0">
                            <button class="btn btn-modern btn-primary btn-outline btn-arrow-effect-1 btn-rounded text-3"
                                id="SubmitConsult">SUBMIT
                                NOW</button>
                        </div>
                    </div>
                </form>
    ...
    <div class='col-md-12 mt-4 text-center'>
        <h4 class='font-weight-semibold mb-2 pb-1 appear-animation animated fadeInUpShorter appear-animation-visible'>
            Share
            this Post</h4>
    </div>
    <div class='share-buttons-container'>
        <div class='share-list'> <a class='fb-h' onclick='return fbs_click()' target='_blank' title='FACEBOOK'> <img
                    src='https://img.icons8.com/material-rounded/96/000000/facebook-f.png'> </a> <a class='tw-h'
                onclick='return tbs_click()' target='_blank' title='TWITTER'> <img
                    src='https://img.icons8.com/material-rounded/96/000000/twitter-squared.png'> </a> <a class='li-h'
                onclick='return lbs_click()' target='_blank' title='LINKEDIN'> <img
                    src='https://img.icons8.com/material-rounded/96/000000/linkedin.png'> </a> <a
                data-pin-do='buttonPin' data-pin-config='none' class='pi-h' onclick='return pbs_click()' target='_blank'
                title='PINTEREST'> <img src='https://img.icons8.com/ios-glyphs/90/000000/pinterest.png'> </a> </div>
    </div>
